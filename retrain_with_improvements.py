...
def main():
    ...
    if not args.skip_threshold:
        ...
        results_summary['improvements_applied'].append('threshold_optimization')
        ...
        for model_name in models:
            ...
            # Save thresholds
            threshold_file = results_dir / f'{model_name}_optimal_thresholds.json'
    ...
    if not args.skip_tta:
        ...
        results_summary['improvements_applied'].append('test_time_augmentation')
