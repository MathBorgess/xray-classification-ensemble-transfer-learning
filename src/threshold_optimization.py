...
def evaluate_with_threshold(
    ...
    f1 = 2 * (precision * sensitivity) / (precision +
...
def plot_threshold_analysis(
    ...
    # Mark optimal points
    colors = {'youden': 'red', 'f1': 'blue',
              'balanced': 'green', 'target_specificity': 'purple'}
    ...
    plt.tight_layout()
    plt.savefig(Path(save_dir) / 'threshold_optimization.png',
